(function () {
	...
	/**
	 * Responsive Hero Slider Background Image
	 */
	// Get Client Browser Width
	const mobileScreen = window.matchMedia("(max-width:420px)");
	// Get Slides
	let firstSlide = select(".hero-slider .swiper-slide:nth-child(1)");
	let secondSlide = select(".hero-slider .swiper-slide:nth-child(2)");
	let thirdSlide = select(".hero-slider .swiper-slide:nth-child(3)");
	let fourthSlide = select(".hero-slider .swiper-slide:nth-child(4)");
	let fifthSlide = select(".hero-slider .swiper-slide:nth-child(5)");
